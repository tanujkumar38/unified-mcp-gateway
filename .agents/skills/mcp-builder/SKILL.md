...
python "C:/Users/tanuj/.gemini/config/skills/mcp-builder/scripts/mcp_scaffold.py" \
...
```bash
python "C:/Users/tanuj/.gemini/config/skills/mcp-builder/scripts/verify_mcp_server.py" \
